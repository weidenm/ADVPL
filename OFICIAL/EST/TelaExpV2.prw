...
//******************************************************************************
	...
	@ 004, 210 SAY oTxtRota PROMPT cRota SIZE 200, 011 OF oGroup1 FONT oFont1 COLORS 0, 16777215 PIXEL //Nome do responsแvel pela programa็ใo da produ็ใo
...
// COPIADO PARA CARREGAM. EXCLUIR SE NรO DER ERRO
/*	cQry := ""
	aDadosC := {}
	cProdGrid := ""
	nQtdFardo:=0
