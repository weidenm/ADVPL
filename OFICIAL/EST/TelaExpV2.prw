...
//******************************************************************************
	...
	@ 004, 135 SAY oLblVeic PROMPT "Veํculo:" SIZE 060, 011 OF oGroup1 FONT oFont2 COLORS 0, 16777215 PIXEL
	@ 004, 170 SAY oTxtVeic PROMPT 	cVeic SIZE 030, 011 OF oGroup1 FONT oFont3 COLORS 0, 16777215 PIXEL
	@ 015, 135 SAY oLblSaida PROMPT "Saํda:"   SIZE 060, 011 OF oGroup1 FONT oFont2 COLORS 0, 16777215 PIXEL
	...
	@ 004, 270 SAY oTxtRota PROMPT substr(cRota,1,20) SIZE 120, 011 OF oGroup1 FONT oFont3 COLORS 0, 16777215 PIXEL //Nome do responsแvel pela programa็ใo da produ็ใo
	@ 004, 340 SAY oTxtRota1 PROMPT substr(cRota,21,25) SIZE 070, 011 OF oGroup1 FONT oFont3 COLORS 0, 16777215 PIXEL //Nome do responsแvel pela programa็ใo da produ็ใo
	...
	//u_GridCarga2()
	//@ 005,550 CHECKBOX oCbxFinalizados VAR lCbxFinalizados PROMPT "Mostra itens concluํdos" SIZE 080, 010 OF oDlg2 COLORS 0, 16777215 ON CHANGE ExibeFinaliz() PIXEL
...
//	EndIf
	...
	For I:= 1 To Len(aDadosC)
		...
		aColsExCg[nLin,03] := Transform(aDadosC[i][3],"@E 9999")  //aColsExCg[nLin,03] := Transform(aDadosC[i][3],"@E 999,999,999")
		aColsExCg[nLin,04] := Transform(aDadosC[i][4],"@E 9999")  //aColsExCg[nLin,04] := Transform(aDadosC[i][4],"@E 999,999,999")
		aColsExCg[nLin,05] := Transform(aDadosC[i][5],"@E 9999")   //aColsExCg[nLin,05] := Transform(aDadosC[i][5],"@E 999,999,999")
    ...
    // Cria Browse
	//oBrowse := TCBrowse():New(020,140,aSize[6]-400,aSize[5]-900,,{'','PRODUTO','DESCRIวรO','QUANTIDADE','REGISTRADO','RESTANTE','EXCEDENTE','MOTIVO FALTA'},{10,50,50,50,50,50,50,50},oDlg2,,,,,,,oFontGrid,,,,,.F.,,.T.,,.F.,,,.T.)
...
//A coluna 6 precisa estแ com a op็ใo de editar .T.
	oBrowse:nLinhas := 2
 ...
 */
	...
	//TButton():New( 184, 004, "Letra M้dia", oDlg2,{|| oBrowse:GoUp(), oBrowse:setFocus() },80,010,,,.F.,.T.,.F.,,.F.,,,.F. )
...
//	alert(str(len(aColsExCg)))
//	alert(str(len(oBrowse:aArray)))
...
//	EndIf
	...
	//oMSNewGe2:Show ()
        ...
        // Cria Browse
	oBrowse := TCBrowse():New(020,140,aSize[6],aSize[5],,{'','PRODUTO','DESCRIวรO','QUANTIDADE','REGISTRADO','RESTANTE','EXCEDENTE','MOTIVO FALTA'},{10,50,50,50,50,50,50,50},oDlg2,,,,,,,oFontGrid,,,,,.F.,,.T.,,.F.,,,)
		...
		/*	if SZ3->Z3_PRODUTO <> cProdCar
			//Deve funcionar apenas quanto TES de Notas de Entrada e Devolu็ใo estiverem com Estoque=N.
				...
				If lMsErroAuto
					...
					ENVMAILEXP('sistemas@produtosplinc.com.br',"Erro na req. para expedi็ใo" ,"Nใo foi possํvel requisitar os produtos.")
				EndIf
